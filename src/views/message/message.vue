...
<template>
    <div class="message-main-con">
        <div class="message-mainlist-con">
            <div>
                <Button @click="setCurrentMesType('unread')" size="large" long type="text"><transition name="mes-current-type-btn"><Icon v-show="currentMessageType === 'unread'" type="checkmark"></Icon></transition><span class="mes-type-btn-text">Unread messages</span><Badge class="message-count-badge-outer" class-name="message-count-badge" :count="unreadCount"></Badge></Button>
            </div>
            <div>
...
export default {
    ...
    methods: {
        ...
        setCurrentMesType (type) {
            ...
            if (type === 'unread') {
                this.noDataText = 'No unread news';
                this.currentMesList = this.unreadMesList;
            } else if (type === 'hasread') {
                this.noDataText = 'No news yet';
                this.currentMesList = this.hasreadMesList;
            } else {
                this.noDataText = 'Recycle bin no news';
        ...
        getContent (index) {
            ...
            switch (this.currentMessageType + index) {
                case 'unread0': mesContent = 'This is what you click on the "Welcome to Backoffice system to understand his purpose," the relevant content.'; break;
                case 'unread1': mesContent = 'Heres what you click on to quickly build your backend system with Backoffice and iView-ui component libraries.'; break;
                case 'unread2': mesContent = 'This is what you click on "like Backoffice, welcome to github home page to a star bar" related content.'; break;
                case 'hasread0': mesContent = 'Heres what you clicked This is a piece of news youve already read'; break;
                default: mesContent = 'Heres what you clicked This is a deleted message.'; break;
            }
