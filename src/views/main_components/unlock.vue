            ...
            <div class="unlock-input-con">
                <div class="unlock-input-overflow-con">
                    <div class="unlock-overflow-body" :style="{right: inputLeft}">
                        <input ref="inputEle" v-model="password" class="unlock-input" type="password" placeholder="Password with login password" />
    ...
    methods: {
        ...
        handleUnlock () {
            if (Cookies.get('password') === this.password) {
                ...
                this.$Message.error('Wrong password, please re-enter. If you forget the password, clear the browser cache to log in again, there is no back-end verification');
            }
        },
        unlockMousedown () {
