...
export default {
    ...
    methods: {
        ...
        moveToView (tag) {
            if (tag.offsetLeft < -this.tagBodyLeft) {
                // The label is to the left of the viewable area
                this.tagBodyLeft = -tag.offsetLeft + 10;
            } else if (tag.offsetLeft + 10 > -this.tagBodyLeft && tag.offsetLeft + tag.offsetWidth < -this.tagBodyLeft + this.$refs.scrollCon.offsetWidth - 100) {
                // Tags in the visible area
            } else {
                // The label is to the right of the viewable area
    ...
    mounted () {
        ...
        }, 1);  // There will be a migration bug without a timer here   
